...
- [`ForthHub/forth`](https://github.com/ForthHub/forth) (2 days ago) • :four_leaf_clover: Forth engine in JavaScript
- [`ARINC-IA/CSMIM`](https://github.com/ARINC-IA/CSMIM) (3 days ago)
- [`richlander/dotnet-inspect`](https://github.com/richlander/dotnet-inspect) (4 days ago) • Tool to inspect .NET assets, like docker inspect.
- [`rvben/rumdl`](https://github.com/rvben/rumdl) (4 days ago) • Markdown Linter and Formatter written in Rust
- [`sanyuan0704/code-review-expert`](https://github.com/sanyuan0704/code-review-expert) (4 days ago) • Expert code review skill: SOLID, security, performance, error handling, boundary conditions
- [`drawdb-io/drawdb`](https://github.com/drawdb-io/drawdb) (4 days ago) • Free, simple, and intuitive online database diagram editor and SQL generator.
- [`salacoste/antigravity-bmad-config`](https://github.com/salacoste/antigravity-bmad-config) (4 days ago) • Antigravity config template: BMad Method (BMAD-METHOD) AI agents via slash commands for PRD→Architecture→Stories→Dev→QA gate.
- [`MoonshotAI/Kimi-K2.5`](https://github.com/MoonshotAI/Kimi-K2.5) (5 days ago) • Moonshot&#39;s most powerful model
- [`openclaw/lobster`](https://github.com/openclaw/lobster) (5 days ago) • Lobster is a Clawdbot-native workflow shell: a typed, local-first “macro engine” that turns skills/tools into composable pipelines and safe automations—and lets Clawdbot call those workflows in one step.
...
- [`@mistkail06`](https://github.com/mistkail06)
- [`@runningdev9998`](https://github.com/runningdev9998)
- [`@evenjo-01`](https://github.com/evenjo-01)
