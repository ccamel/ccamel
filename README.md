...
- [🐑 An opinionated HerdR launcher for how I currently do multi-agent dev in Git repos](https://gist.github.com/46a021372c326f31fdb3b5a55b238214) (1 day ago)
...
- [`withastro/flue`](https://github.com/withastro/flue) (1 day ago) • The sandbox agent framework.
- [`cloudmanic/herdr-plus`](https://github.com/cloudmanic/herdr-plus) (1 day ago) • An extension for herdr, built as a first-class herdr plugin — a collection of tools that make it better: Projects and Quick Actions.
- [`langchain-ai/openwiki`](https://github.com/langchain-ai/openwiki) (3 days ago) • OpenWiki is a CLI that writes and maintains agent documentation for your codebase.
- [`moul/awesome-ascii-art`](https://github.com/moul/awesome-ascii-art) (4 days ago) • A curated list of ascii-art resources
- [`orhun/ratty`](https://github.com/orhun/ratty) (4 days ago) • A GPU-rendered terminal emulator with inline 3D graphics 🐀🧀
- [`birdneststream/asciibird`](https://github.com/birdneststream/asciibird) (4 days ago) • ASCII Creation
- [`cloudflare/kumo`](https://github.com/cloudflare/kumo) (5 days ago) • Cloudflare&#39;s component library for building modern web applications.
- [`orseni/codex-remote-hub`](https://github.com/orseni/codex-remote-hub) (5 days ago)
- [`govctl-org/govctl`](https://github.com/govctl-org/govctl) (5 days ago) • A governance harness for AI coding.
- [`openai/codex-action`](https://github.com/openai/codex-action) (6 days ago)
