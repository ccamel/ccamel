...
I'm now evolving in the World of Cryptos, **Blockchain** Ecosystems and **web3.0** technologies, building with passion the [ØKP4 network](https://okp4.network), a revolutionary public [Layer 1](https://medium.com/okp4/the-layered-structure-of-the-blockchain-7d39b28a48cc) blockchain, based on the [Cosmos SDK](https://v1.cosmos.network/sdk) technology, and designed to enable communities to trustlessly share data, algorithms and resources to build the Dataverse.
