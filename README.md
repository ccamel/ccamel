...
- [`containrrr/watchtower`](https://github.com/containrrr/watchtower) (1 day ago) • A process for automating Docker container base image updates.
- [`tailscale/tailscale`](https://github.com/tailscale/tailscale) (1 day ago) • The easiest, most secure way to use WireGuard and 2FA.
- [`synology-community/terraform-provider-synology`](https://github.com/synology-community/terraform-provider-synology) (1 day ago) • Terraform provider to manage DSM APIs on Synology NAS
- [`fenio/k3s-synology`](https://github.com/fenio/k3s-synology) (1 day ago) • k3s (lightweight kubernetes) on Synology DS216&#43;
- [`restic/restic`](https://github.com/restic/restic) (3 days ago) • Fast, secure, efficient backup program
- [`nicolaka/netshoot`](https://github.com/nicolaka/netshoot) (3 days ago) • a Docker &#43; Kubernetes network trouble-shooting swiss-army container
- [`vrana/adminer`](https://github.com/vrana/adminer) (4 days ago) • Database management in a single PHP file
- [`patroni/patroni`](https://github.com/patroni/patroni) (4 days ago) • A template for PostgreSQL High Availability with Etcd, Consul, ZooKeeper, or Kubernetes
- [`Flux159/mcp-server-kubernetes`](https://github.com/Flux159/mcp-server-kubernetes) (5 days ago) • MCP Server for kubernetes management commands
- [`tidalcycles/strudel`](https://github.com/tidalcycles/strudel) (6 days ago) • Web-based environment for live coding algorithmic patterns, incorporating a faithful port of TidalCycles to JavaScript

## 👯 My recent Followers

- [`@johandraew`](https://github.com/johandraew)
- [`@TariCodes`](https://github.com/TariCodes)
- [`@whocalledit`](https://github.com/whocalledit)
