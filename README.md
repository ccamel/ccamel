...
- [`cloudflare/kumo`](https://github.com/cloudflare/kumo) (1 day ago) • Cloudflare&#39;s component library for building modern web applications.
- [`orseni/codex-remote-hub`](https://github.com/orseni/codex-remote-hub) (1 day ago)
- [`govctl-org/govctl`](https://github.com/govctl-org/govctl) (1 day ago) • A governance harness for AI coding.
- [`openai/codex-action`](https://github.com/openai/codex-action) (2 days ago)
- [`leonardomso/awesome-fsm`](https://github.com/leonardomso/awesome-fsm) (2 days ago) • 🤖 A curated list of awesome resources related to finite state machines and statecharts.
- [`SoCkEt7/Livediff`](https://github.com/SoCkEt7/Livediff) (2 days ago) • ⚡ Livediff: Watch file diffs live in your terminal. Minimalist Rust TUI for instant feedback loops.
- [`bnema/gordon`](https://github.com/bnema/gordon) (3 days ago) • Minimalist self-hosted containerized webapp deployment tool.
- [`headroomlabs-ai/headroom`](https://github.com/headroomlabs-ai/headroom) (3 days ago) • Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 60-95% fewer tokens, same answers. Library, proxy, MCP server.
- [`giancarloerra/SocratiCode`](https://github.com/giancarloerra/SocratiCode) (3 days ago) • Enterprise-grade (40m&#43; LOC) codebase intelligence, zero-setup, local &amp; private Plugin/Skill/Extension or MCP: hybrid semantic search, polyglot dependency graphs, symbol-level impact analysis &amp; call-flow, interactive HTML viewer, cross-project &amp; branch-aware search, DB/API/infra knowledge. 61% less tokens, 84% fewer calls, 37x faster. Cloud in beta.
- [`xbmc/xbmc`](https://github.com/xbmc/xbmc) (4 days ago) • Kodi is an award-winning free and open source home theater/media center software and entertainment hub for digital media. With its beautiful interface and powerful skinning engine, it&#39;s available for Android, BSD, Linux, macOS, iOS, tvOS and Windows.

## My recent Followers

- [`@ozgurulukir`](https://github.com/ozgurulukir)
- [`@NathanHollowayQ`](https://github.com/NathanHollowayQ)
