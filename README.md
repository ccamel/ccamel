...
- [`jamez-bondos/awesome-gpt4o-images`](https://github.com/jamez-bondos/awesome-gpt4o-images) (2 days ago) • Awesome curated collection of images and prompts generated by GPT-4o and gpt-image-1. Explore AI generated visuals created with ChatGPT and Sora, showcasing OpenAI’s advanced image generation capabilities.
- [`freema/mcp-design-system-extractor`](https://github.com/freema/mcp-design-system-extractor) (2 days ago) • MCP (Model Context Protocol) server that enables AI assistants to interact with Storybook design systems. Extract component HTML, analyze styles, and help with design system adoption and refactoring.
- [`bgauryy/octocode-mcp`](https://github.com/bgauryy/octocode-mcp) (2 days ago) • Code search analysys MCP
- [`kopia/kopia`](https://github.com/kopia/kopia) (2 days ago) • Cross-platform backup tool for Windows, macOS &amp; Linux with fast, incremental backups, client-side end-to-end encryption, compression and data deduplication. CLI and GUI included.
- [`Solido/awesome-flutter`](https://github.com/Solido/awesome-flutter) (3 days ago) • An awesome list that curates the best Flutter libraries, tools, tutorials, articles and more.
...
- [`dali-benothmen/cronflow`](https://github.com/dali-benothmen/cronflow) (3 days ago) • The fastest code-first workflow automation engine. TypeScript-native, AI-ready, 98% faster than n8n/Zapier. Built with Rust &#43; Bun.
- [`juehang/vscode-mcp-server`](https://github.com/juehang/vscode-mcp-server) (3 days ago) • MCP server to expose VS Code editing features to an LLM for AI coding
- [`babylonlabs-io/cosmos-bsn-contracts`](https://github.com/babylonlabs-io/cosmos-bsn-contracts) (4 days ago) • CosmWasm smart contracts for Babylon integration
- [`metatool-ai/metamcp`](https://github.com/metatool-ai/metamcp) (6 days ago) • MCP Aggregator, Orchestrator, Middleware, Gateway in one docker
...
- [`@umutsar`](https://github.com/umutsar)
- [`@alexcj10`](https://github.com/alexcj10)
- [`@AbasThomas`](https://github.com/AbasThomas)
- [`@onamfc`](https://github.com/onamfc)
- [`@mayannaoliveira`](https://github.com/mayannaoliveira)
...
- [Bash sorcery to summon all WASM contracts from the Axone chain and unveil their real nature](https://gist.github.com/f8aea954bc73d5cad3f33812085b3b88) (6 months ago)
...
- [dendrite-1 testnet validators onboarding](https://gist.github.com/1350b948eaa0828757fc54b1e7c94f5d) (11 months ago)
