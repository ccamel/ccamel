...
- [`directus/directus`](https://github.com/directus/directus) (2 days ago) • The flexible backend for all your projects 🐰 Turn your DB into a headless CMS, admin panels, or apps with a custom UI, instant APIs, auth &amp; more.
- [`spruceid/siwe`](https://github.com/spruceid/siwe) (2 days ago) • Sign-In with Ethereum library
- [`knative-extensions/eventing-rabbitmq`](https://github.com/knative-extensions/eventing-rabbitmq) (3 days ago) • RabbitMQ eventing components. Knative Source and Broker.
- [`microsoft/WSL`](https://github.com/microsoft/WSL) (4 days ago) • Windows Subsystem for Linux
- [`microsoft/terraform-provider-azuredevops`](https://github.com/microsoft/terraform-provider-azuredevops) (4 days ago) • Terraform Azure DevOps provider
- [`mindsdb/mindsdb`](https://github.com/mindsdb/mindsdb) (4 days ago) • AI&#39;s query engine - Platform for building AI that can answer questions over large scale federated data. - The only MCP Server you&#39;ll ever need
- [`kgateway-dev/kgateway`](https://github.com/kgateway-dev/kgateway) (5 days ago) • The Cloud-Native API Gateway and AI Gateway
- [`lasso-security/mcp-gateway`](https://github.com/lasso-security/mcp-gateway) (5 days ago) • A plugin-based gateway that orchestrates other MCPs and allows developers to build upon it enterprise-grade agents.
- [`mcp-ecosystem/mcp-gateway`](https://github.com/mcp-ecosystem/mcp-gateway) (5 days ago) • 🧩 MCP Gateway - A lightweight gateway service that instantly transforms existing MCP Servers and APIs into MCP servers with zero code changes. Features Docker deployment and management UI, requiring no infrastructure modifications.
- [`containrrr/watchtower`](https://github.com/containrrr/watchtower) (1 week ago) • A process for automating Docker container base image updates.

## 👯 My recent Followers

- [`@MonoPX`](https://github.com/MonoPX)
- [`@Sawi78112`](https://github.com/Sawi78112)
- [`@elite-gem89`](https://github.com/elite-gem89)
- [`@hitman0290`](https://github.com/hitman0290)
- [`@AmirPeyravan`](https://github.com/AmirPeyravan)
- [`@156afl`](https://github.com/156afl)
- [`@Incredidev9285`](https://github.com/Incredidev9285)
- [`@Nathan5467`](https://github.com/Nathan5467)
- [`@Renan092992`](https://github.com/Renan092992)
- [`@marichu-kt`](https://github.com/marichu-kt)

## 📕 My Latest Gists

- [One-liner sorcery to rip stats from the Axone Cognitarium smart contract (🔗 https://axone.xyz)](https://gist.github.com/75628fd9b042f30cfaaf2507338f9b50) (2 months ago)
- [One-liner to conjure all Axone airdrop giga-chads — proof of participation on-chain (https://airdrop.axone.xyz)](https://gist.github.com/25a453db78023df8c8cd7bf9c20be800) (2 months ago)
- [Bash sorcery to summon all WASM contracts from the Axone chain and unveil their real nature](https://gist.github.com/f8aea954bc73d5cad3f33812085b3b88) (3 months ago)
...
- [Simple magical one-line bash command to graph KatAI contributions over time (https://katai.xyz)](https://gist.github.com/f27603e36d7b4e6f2bfc5c5454f71cdd) (8 months ago)
- [A bash script to automatically approve and politely ask Dependabot to merge its own PRs, because I’m a bit lazy and happy to let the bots handle the hard part (if the CI behaves)!](https://gist.github.com/67af201be688b1d169645e51e9ae6234) (8 months ago)
- [dendrite-1 testnet validators onboarding](https://gist.github.com/1350b948eaa0828757fc54b1e7c94f5d) (8 months ago)
