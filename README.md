...
- [`botcrypto-io/awesome-crypto-trading-bots`](https://github.com/botcrypto-io/awesome-crypto-trading-bots) (1 day ago) • Awesome crypto trading bots
- [`hazae41/labase`](https://github.com/hazae41/labase) (1 day ago) • The Tailwind framework for monochrome apps
- [`onlook-dev/onlook`](https://github.com/onlook-dev/onlook) (1 day ago) • The open source Cursor for Designers. Design directly in your live React app and publish your changes to code.
- [`kern/filepizza`](https://github.com/kern/filepizza) (2 days ago) • :pizza: Peer-to-peer file transfers in your browser
- [`automatisch/automatisch`](https://github.com/automatisch/automatisch) (2 days ago) • The open source Zapier alternative. Build workflow automation without spending time and money.
...
- [`aldi/awesome-bulma`](https://github.com/aldi/awesome-bulma) (3 days ago) • 🎉 A curated list of awesome things related to Bulma CSS Framework
- [`satnaing/shadcn-admin`](https://github.com/satnaing/shadcn-admin) (3 days ago) • Admin Dashboard UI built with Shadcn and Vite.
- [`MystenLabs/awesome-move`](https://github.com/MystenLabs/awesome-move) (4 days ago) • Code and content from the Move community.
- [`not-fl3/macroquad`](https://github.com/not-fl3/macroquad) (5 days ago) • Cross-platform game engine in Rust.
...
- [A collection of handy one-liners leveraging the Axoned CLI for interacting with the Axone blockchain](https://gist.github.com/44cbc7d8e42f183dcbc78c85ebf404d0) (1 week ago)
