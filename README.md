...
- [`Col-E/Recaf`](https://github.com/Col-E/Recaf) (1 day ago) • The modern Java bytecode editor
- [`lenhoanglnh/manuscripts`](https://github.com/lenhoanglnh/manuscripts) (2 days ago) • Scripts de vidéos et d&#39;articles destinés à être publiés.
- [`ai-dynamo/dynamo`](https://github.com/ai-dynamo/dynamo) (2 days ago) • A Datacenter Scale Distributed Inference Serving Framework
- [`hadronlabs-org/drop-contracts`](https://github.com/hadronlabs-org/drop-contracts) (3 days ago) • Drop is an integrated cross-chain liquid staking protocol
- [`aldi/awesome-bulma-templates`](https://github.com/aldi/awesome-bulma-templates) (4 days ago) • 🚀 Free real-world templates built with Bulma
- [`mrtazz/checkmake`](https://github.com/mrtazz/checkmake) (5 days ago) • experimental linter/analyzer for Makefiles
- [`liuchengxu/space-vim-dark`](https://github.com/liuchengxu/space-vim-dark) (5 days ago) • :purple_heart: A dark colorscheme for space-vim, see space-vim-theme for light background support!
- [`punkpeye/awesome-mcp-servers`](https://github.com/punkpeye/awesome-mcp-servers) (5 days ago) • A collection of MCP servers.
- [`astral-sh/uv`](https://github.com/astral-sh/uv) (6 days ago) • An extremely fast Python package and project manager, written in Rust.
- [`SesameAILabs/csm`](https://github.com/SesameAILabs/csm) (1 week ago) • A Conversational Speech Generation Model
...
- [`@IRK600`](https://github.com/IRK600)
- [`@Shamim-Al-Mamun`](https://github.com/Shamim-Al-Mamun)
- [`@sungeer`](https://github.com/sungeer)
- [`@mahmudnibir`](https://github.com/mahmudnibir)
- [`@seanwevans`](https://github.com/seanwevans)
- [`@eriksol116`](https://github.com/eriksol116)
- [`@odest`](https://github.com/odest)

## 📕 My Latest Gists

- [One-liner sorcery to rip stats from the Axone Cognitarium smart contract (🔗 https://axone.xyz)](https://gist.github.com/75628fd9b042f30cfaaf2507338f9b50) (2 weeks ago)
- [One-liner to conjure all Axone airdrop giga-chads — proof of participation on-chain (https://airdrop.axone.xyz)](https://gist.github.com/25a453db78023df8c8cd7bf9c20be800) (3 weeks ago)
