...
- [`BartoszMilewski/DaoFP`](https://github.com/BartoszMilewski/DaoFP) (1 day ago) • The Dao of Functional Programming
- [`mjovanc/numru`](https://github.com/mjovanc/numru) (3 days ago) • A high-performance numeric computation library.
- [`morrna/fractal-play`](https://github.com/morrna/fractal-play) (4 days ago)
- [`andreasvc/vim-256noir`](https://github.com/andreasvc/vim-256noir) (4 days ago) • A dark 256-color colorscheme for vim
- [`dzhng/deep-research`](https://github.com/dzhng/deep-research) (4 days ago) • An AI-powered research assistant that performs iterative, deep research on any topic by combining search engines, web scraping, and large language models. The goal of this repo is to provide the simplest implementation of a deep research agent - e.g. an agent that can refine its research direction overtime and deep dive into a topic.
- [`exo-explore/exo`](https://github.com/exo-explore/exo) (5 days ago) • Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
- [`Confidenceman02/scion-tools`](https://github.com/Confidenceman02/scion-tools) (5 days ago) • Elm inspired functional programming in Go
- [`mfinelli/setup-imagemagick`](https://github.com/mfinelli/setup-imagemagick) (1 week ago) • github action to install imagemagick
- [`xu-cheng/texlive-action`](https://github.com/xu-cheng/texlive-action) (1 week ago) • :octocat: GitHub Action to run arbitrary commands in a TeXLive environment
- [`hspazio/vim-advanced-cheatsheet`](https://github.com/hspazio/vim-advanced-cheatsheet) (1 week ago) • Personally curated list of advanced Vim tricks
...
- [Bash sorcery to summon all WASM contracts from the Axone chain and unveil their real nature](https://gist.github.com/f8aea954bc73d5cad3f33812085b3b88) (2 weeks ago)
- [A collection of handy one-liners leveraging the Axoned CLI for interacting with the Axone blockchain](https://gist.github.com/44cbc7d8e42f183dcbc78c85ebf404d0) (4 weeks ago)
