...
- [`eco-stake/restake-ui`](https://github.com/eco-stake/restake-ui) (1 day ago) • Auto-compounder app for Cosmos blockchains using Authz
- [`nextcloud/server`](https://github.com/nextcloud/server) (2 days ago) • ☁️ Nextcloud server, a safe home for all your data
- [`kentaro-m/auto-assign-action`](https://github.com/kentaro-m/auto-assign-action) (2 days ago) • An action which adds reviewers to the pull request when the pull request is opened.
- [`axone-protocol/awesome`](https://github.com/axone-protocol/awesome) (2 days ago) • 🕶 List of public resources, documents, and tools for AXONE.
- [`rustfs/rustfs`](https://github.com/rustfs/rustfs) (3 days ago) • 🚀 High-performance distributed object storage for MinIO alternative.
- [`defstream/kickable-rs`](https://github.com/defstream/kickable-rs) (3 days ago) • Can you kick it?
- [`tareqimbasher/cargo-seek`](https://github.com/tareqimbasher/cargo-seek) (4 days ago) • A terminal user interface for searching, adding and installing cargo crates.
- [`czlonkowski/n8n-mcp`](https://github.com/czlonkowski/n8n-mcp) (4 days ago) • A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8n workflows for you
- [`nodejumper-org/monitoring-tool`](https://github.com/nodejumper-org/monitoring-tool) (1 week ago) • A powerful and easy-to-use monitoring tool for server hardware and validator nodes with alerts via telegram bot
- [`googleapis/genai-toolbox`](https://github.com/googleapis/genai-toolbox) (1 week ago) • MCP Toolbox for Databases is an open source MCP server for databases.
