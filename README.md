...
- [`hspazio/vim-advanced-cheatsheet`](https://github.com/hspazio/vim-advanced-cheatsheet) (1 day ago) • Personally curated list of advanced Vim tricks
- [`sxyazi/yazi`](https://github.com/sxyazi/yazi) (2 days ago) • 💥 Blazing fast terminal file manager written in Rust, based on async I/O.
- [`darrenburns/posting`](https://github.com/darrenburns/posting) (4 days ago) • The modern API client that lives in your terminal.
- [`skip-mev/skip-go-registry`](https://github.com/skip-mev/skip-go-registry) (5 days ago)
- [`hyperweb-io/interchain-ui`](https://github.com/hyperweb-io/interchain-ui) (6 days ago) • Cross-framework UI Kit for Crafting dApps in the Interchain
- [`onomyprotocol/onomy`](https://github.com/onomyprotocol/onomy) (6 days ago) • Onomy Network Provider Chain Software
- [`axone-protocol/slips`](https://github.com/axone-protocol/slips) (1 week ago) • SatoshiLabs Improvement Proposals
- [`mars-protocol/cw-asset`](https://github.com/mars-protocol/cw-asset) (1 week ago) • A unified representation of various types of Cosmos fungible assets, and helper functions for interacting with them
- [`Fairblock/fairyring`](https://github.com/Fairblock/fairyring) (1 week ago)
- [`block/goose`](https://github.com/block/goose) (1 week ago) • an open-source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM

## 👯 My recent Followers

- [`@hipolitorodrigues`](https://github.com/hipolitorodrigues)
- [`@suumiizxc123`](https://github.com/suumiizxc123)
- [`@mahseema`](https://github.com/mahseema)
- [`@lkim227`](https://github.com/lkim227)
- [`@Lasim`](https://github.com/Lasim)
...
- [`@virtusdevx`](https://github.com/virtusdevx)

## 📕 My Latest Gists

- [Bash sorcery to summon all WASM contracts from the Axone chain and unveil their real nature](https://gist.github.com/f8aea954bc73d5cad3f33812085b3b88) (1 week ago)
- [A collection of handy one-liners leveraging the Axoned CLI for interacting with the Axone blockchain](https://gist.github.com/44cbc7d8e42f183dcbc78c85ebf404d0) (3 weeks ago)
...
- [dendrite-1 testnet validators onboarding](https://gist.github.com/1350b948eaa0828757fc54b1e7c94f5d) (5 months ago)
