...
- [`curl/curl`](https://github.com/curl/curl) (3 days ago) • A command line tool and library for transferring data with URL syntax, supporting DICT, FILE, FTP, FTPS, GOPHER, GOPHERS, HTTP, HTTPS, IMAP, IMAPS, LDAP, LDAPS, MQTT, POP3, POP3S, RTMP, RTMPS, RTSP, SCP, SFTP, SMB, SMBS, SMTP, SMTPS, TELNET, TFTP, WS and WSS. libcurl offers a myriad of powerful features
- [`sanathkr/go-npm`](https://github.com/sanathkr/go-npm) (6 days ago) • Distribute and install Go binaries via NPM
- [`larry0x/cw-plus-plus`](https://github.com/larry0x/cw-plus-plus) (6 days ago) • A collection of CosmWasm utilities and helper functions that I use
- [`klaudiosinani/awesome-prolog`](https://github.com/klaudiosinani/awesome-prolog) (6 days ago) • Curated list of Prolog packages and resources
- [`brezzergit/LinkedIn-LLM-Post-Generator`](https://github.com/brezzergit/LinkedIn-LLM-Post-Generator) (1 week ago) • LinkedIn LLM Post Generator – Generate high-quality, professional LinkedIn posts completely offline using a fine-tuned open-source model (TinyLLaMA-1.1B-Chat). Built with PEFT &#43; LoRA on Apple M3, this project requires no cloud APIs and supports themes like internships, promotions, certifications, and project completions.
- [`actions-rust-lang/setup-rust-toolchain`](https://github.com/actions-rust-lang/setup-rust-toolchain) (1 week ago) • Setup a specific Rust toolchain with extra features like problem matchers
- [`r4topunk/cosmwasm-ai-delegated-spend`](https://github.com/r4topunk/cosmwasm-ai-delegated-spend) (1 week ago)
- [`MarkusZoppelt/portfolio_rs`](https://github.com/MarkusZoppelt/portfolio_rs) (1 week ago) • A command line tool for managing financial investment portfolios.
- [`jaywcjlove/awesome-mac`](https://github.com/jaywcjlove/awesome-mac) (1 week ago) •  Now we have become very big, Different from the original idea. Collect premium software in various categories.
- [`rikulauttia/gRPC-Redis-Postgres-Engine`](https://github.com/rikulauttia/gRPC-Redis-Postgres-Engine) (1 week ago) • High-Performance Rust Backend using Rust, gRPC, Redis, and PostgreSQL. This project focuses on creating a scalable backend system capable of handling millions of requests per second, ideal for applications like messaging services or social network feeds.
...
- [`@VenomousKnight`](https://github.com/VenomousKnight)
- [`@sasmithx`](https://github.com/sasmithx)
- [`@akifgrape`](https://github.com/akifgrape)
- [`@alexbrownm`](https://github.com/alexbrownm)
