...
- [`chuanqisun/react-agent-hooks`](https://github.com/chuanqisun/react-agent-hooks) (2 days ago) • Turn React hooks into LLM tools
- [`talzach/mcp-angular-cli`](https://github.com/talzach/mcp-angular-cli) (2 days ago) • Model Context Protocol servers for Angular CLI
- [`HyperbolicLabs/hyperbolic-mcp`](https://github.com/HyperbolicLabs/hyperbolic-mcp) (3 days ago) • MCP Server for Claude
- [`apple/container`](https://github.com/apple/container) (6 days ago) • A tool for creating and running Linux containers using lightweight virtual machines on a Mac. It&#39;s written in Swift, and optimized for Apple silicon.
- [`zcaceres/fetch-mcp`](https://github.com/zcaceres/fetch-mcp) (6 days ago) • A flexible HTTP fetching Model Context Protocol server.
- [`ferrislucas/iterm-mcp`](https://github.com/ferrislucas/iterm-mcp) (6 days ago) • A Model Context Protocol server that executes commands in the current iTerm session - useful for REPL and CLI assistance
- [`MicrosoftDocs/mcp`](https://github.com/MicrosoftDocs/mcp) (1 week ago)
- [`railwayapp/nixpacks`](https://github.com/railwayapp/nixpacks) (1 week ago) • App source &#43; Nix packages &#43; Docker = Image
- [`metorial/mcp-containers`](https://github.com/metorial/mcp-containers) (1 week ago) • Containerized versions of hundreds of MCP servers 📡 🧠
- [`steipete/agent-rules`](https://github.com/steipete/agent-rules) (1 week ago) • Rules and Knowledge to work better with agents such as Claude Code or Cursor
