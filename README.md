...
<a href="https://twitter.com/7h3_360l355_d3v" target="_blank">
  <img src="https://img.shields.io/badge/Twitter-000000?style=for-the-badge&logo=x&logoColor=white" alt="x (twitter)" /></a>&nbsp;&nbsp;&nbsp;
...
- [🐑 An opinionated HerdR launcher for how I currently do multi-agent dev in Git repos](https://gist.github.com/46a021372c326f31fdb3b5a55b238214) (2 weeks ago)
- [My personal archive of surrealist prompts](https://gist.github.com/4bed0857811867dcdb5491bfdc975578) (8 months ago)
- [my own collection of absurd and self-referential paradoxes from within the machine](https://gist.github.com/d4c7a7cd812906dfebc61a027805029d) (8 months ago)
...
- [Bash sorcery to summon all WASM contracts from the Axone chain and unveil their real nature](https://gist.github.com/f8aea954bc73d5cad3f33812085b3b88) (2 years ago)
- [A collection of handy one-liners leveraging the Axoned CLI for interacting with the Axone blockchain](https://gist.github.com/44cbc7d8e42f183dcbc78c85ebf404d0) (2 years ago)

## Recent Stars

- [`mcpshim/mcpshim`](https://github.com/mcpshim/mcpshim) (1 day ago) • Turn remote MCP servers into local command workflows.
- [`donomii/sceneCamera`](https://github.com/donomii/sceneCamera) (1 day ago) • 3D camera library for Go with museum, FPS, RTS, and stereo rendering modes.
- [`lsd-rs/lsd`](https://github.com/lsd-rs/lsd) (2 days ago) • The next gen ls command
- [`morhetz/gruvbox`](https://github.com/morhetz/gruvbox) (2 days ago) • Retro groove color scheme for Vim
- [`subframe7536/maple-font`](https://github.com/subframe7536/maple-font) (5 days ago) • Maple Mono: Open source monospace font with round corner, ligatures and Nerd-Font icons for IDE and terminal, fine-grained customization options. 带连字和控制台图标的圆角等宽字体，中英文宽度完美2:1，细粒度的自定义选项
- [`quodeq/quodeq`](https://github.com/quodeq/quodeq) (6 days ago) • AI-powered code quality and security scanner. Open source, MIT, runs locally. &lt;🧭&gt;
- [`fredericvilcot/clean-claude`](https://github.com/fredericvilcot/clean-claude) (1 week ago) • Stop prompting. Start crafting. — Transforms Claude Code into 6 reactive AI agents (PO, Architect, Frontend, Backend, QA, DevOps) that collaborate to deliver clean, tested, architected React &#43; TypeScript frontends. Hexagonal architecture, Result types, BDD tests, CI/CD — all crafted.
- [`dutchcoders/gister`](https://github.com/dutchcoders/gister) (1 week ago) • Manage your gists from the command-line.
- [`akunzai/gistui`](https://github.com/akunzai/gistui) (1 week ago) • A terminal UI for managing GitHub Gists
- [`mattpocock/skills`](https://github.com/mattpocock/skills) (1 week ago) • Skills for Real Engineers. Straight from my .agents directory.

## My recent Followers

- [`@estellepicq`](https://github.com/estellepicq)
- [`@HealerCodeLabs`](https://github.com/HealerCodeLabs)
- [`@DanielArturoAlejoAlvarez`](https://github.com/DanielArturoAlejoAlvarez)
- [`@josejairobaltazargallegos0-star`](https://github.com/josejairobaltazargallegos0-star)
...
- [`@heeshar`](https://github.com/heeshar)
