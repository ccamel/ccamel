...
- [`gnolang/gno`](https://github.com/gnolang/gno) (2 days ago) • Gno: An interpreted, stack-based Go virtual machine to build succinct and composable apps &#43; gno.land: a blockchain for timeless code and fair open-source.
- [`skade/lazers`](https://github.com/skade/lazers) (2 days ago) • A couchdb client in Rust
- [`ssloy/tinycompiler`](https://github.com/ssloy/tinycompiler) (2 days ago) • Writing a compiler in a week-end
- [`ory/keto`](https://github.com/ory/keto) (3 days ago) • The most scalable and customizable permission server on the market. Fix your slow or broken permission system with Google&#39;s proven &#34;Zanzibar&#34; approach. Supports ACL, RBAC, and more. Written in Go, cloud native, headless, API-first. Available as a service on Ory Network and for self-hosters.
- [`opsmanager1/Axone`](https://github.com/opsmanager1/Axone) (5 days ago)
- [`bram209/leptosfmt`](https://github.com/bram209/leptosfmt) (6 days ago) • A formatter for the leptos view! macro
- [`Arindam200/logo-ai`](https://github.com/Arindam200/logo-ai) (1 week ago) • AI Powered Logo Generator | Powered by Nebius AI
- [`cordx56/rustowl`](https://github.com/cordx56/rustowl) (1 week ago) • Visualize Ownership and Lifetimes in Rust
- [`BartoszMilewski/DaoFP`](https://github.com/BartoszMilewski/DaoFP) (1 week ago) • The Dao of Functional Programming
- [`mjovanc/numru`](https://github.com/mjovanc/numru) (1 week ago) • A high-performance numeric computation library.

## 👯 My recent Followers

- [`@Basant1Saini`](https://github.com/Basant1Saini)
- [`@burakacar7`](https://github.com/burakacar7)
...
- [Bash sorcery to summon all WASM contracts from the Axone chain and unveil their real nature](https://gist.github.com/f8aea954bc73d5cad3f33812085b3b88) (3 weeks ago)
