...
- [`LimeSurvey/LimeSurvey`](https://github.com/LimeSurvey/LimeSurvey) (1 day ago) • 🔥 LimeSurvey – A powerful, open-source survey platform. A free alternative to SurveyMonkey, Typeform, Qualtrics, and Google Forms, making it simple to create online surveys and forms with unmatched flexibility.
- [`agent0lab/agent0-py`](https://github.com/agent0lab/agent0-py) (2 days ago) • Agent0 is the SDK for agentic economies: open discovery and trust for agents
- [`dawid-dahl-umain/augmented-ai-development`](https://github.com/dawid-dahl-umain/augmented-ai-development) (2 days ago) • A Disciplined TDD Approach to AI-Assisted Software Development
- [`graphile/migrate`](https://github.com/graphile/migrate) (2 days ago) • Opinionated SQL-powered productive roll-forward migration tool for PostgreSQL.
- [`semantic-release/commit-analyzer`](https://github.com/semantic-release/commit-analyzer) (2 days ago) • :bulb: semantic-release plugin to analyze commits with conventional-changelog
- [`jasonwitty/socktop`](https://github.com/jasonwitty/socktop) (2 days ago) • socktop is a remote system monitor with a rich TUI interface, inspired by `top` and `btop`, that communicates with a lightweight remote agent over WebSockets.
- [`RostislavDugin/postgresus`](https://github.com/RostislavDugin/postgresus) (3 days ago) • PostgreSQL monitoring and backups (with UI and self hosted)
- [`dataplane-app/dataplane`](https://github.com/dataplane-app/dataplane) (3 days ago) • Dataplane is an Airflow inspired unified data platform with additional data mesh and RPA capability to automate, schedule and design data pipelines and workflows. Dataplane is written in Golang with a React front end.
- [`node-opcua/node-opcua`](https://github.com/node-opcua/node-opcua) (4 days ago) • Unlocking the Full Potential of OPC UA with Typescript and NodeJS - http://node-opcua.github.io/
- [`jesseduffield/lazydocker`](https://github.com/jesseduffield/lazydocker) (4 days ago) • The lazier way to manage everything docker

## 👯 My recent Followers

- [`@georgerobescu`](https://github.com/georgerobescu)
- [`@mikebuzzer`](https://github.com/mikebuzzer)
- [`@OftenUser`](https://github.com/OftenUser)
- [`@vokrob`](https://github.com/vokrob)
- [`@ankitaaryal`](https://github.com/ankitaaryal)
...
- [`@pethmm`](https://github.com/pethmm)
