...
<ul>
  ...
  <li><code><a href="https://github.com/axone-protocol/prolog">axone-protocol/prolog</a></code>&nbsp;<a href="https://github.com/axone-protocol/prolog/releases/tag/v3.2.0"><img align="center" alt="v3.2.0" src="https://img.shields.io/badge/v3.2.0-gray?style=flat-square" /></a>&nbsp;•&nbsp;🧠 The Axone Prolog VM</li>
  <li><code><a href="https://github.com/realopslabs/kubeledger">realopslabs/kubeledger</a></code>&nbsp;<a href="https://github.com/realopslabs/kubeledger/releases/tag/v26.01.1"><img align="center" alt="v26.01.1" src="https://img.shields.io/badge/v26.01.1-gray?style=flat-square" /></a>&nbsp;•&nbsp;The System of Record for Kubernetes Accounting. Tracks CPU/RAM/GPU usage per namespace. Reveals hidden overhead. Get Insights for cost optimization. (Formerly Kube-Opex-Analytics).</li>
  <li><code><a href="https://github.com/axone-protocol/axoned">axone-protocol/axoned</a></code>&nbsp;<a href="https://github.com/axone-protocol/axoned/releases/tag/v14.0.0"><img align="center" alt="v14.0.0" src="https://img.shields.io/badge/v14.0.0-gray?style=flat-square" /></a>&nbsp;•&nbsp;⛓️ Axone blockchain 💫</li>
  <li><code><a href="https://github.com/hazae41/bobine">hazae41/bobine</a></code>&nbsp;<a href="https://github.com/hazae41/bobine/releases/tag/v0.0.22"><img align="center" alt="v0.0.22" src="https://img.shields.io/badge/v0.0.22-gray?style=flat-square" /></a>&nbsp;•&nbsp;A blockchain in your garage</li>
  <li><code><a href="https://github.com/ccamel/bobinerie">ccamel/bobinerie</a></code>&nbsp;<a href="https://github.com/ccamel/bobinerie/releases/tag/5"><img align="center" alt="5" src="https://img.shields.io/badge/5-gray?style=flat-square" /></a>&nbsp;•&nbsp;🧵 La Bobinerie - Haberdashery of Bobine modules: from useful, serious pieces to educational gems and esoteric oddities. Grab, deploy, fork at will.</li>
...
- [`gofr-dev/gofr`](https://github.com/gofr-dev/gofr) (1 day ago) • An opinionated GoLang framework for accelerated microservice development. Built in support for databases and observability.
- [`garrytan/gstack`](https://github.com/garrytan/gstack) (2 days ago) • Use Garry Tan&#39;s exact Claude Code setup: 6 opinionated tools that serve as CEO, Eng Manager, Release Manager and QA Engineer
- [`squidfunk/mkdocs-material`](https://github.com/squidfunk/mkdocs-material) (2 days ago) • Documentation that simply works
- [`gurgeous/tennis`](https://github.com/gurgeous/tennis) (2 days ago) • stylish CSV tables in your terminal
- [`paperclipai/paperclip`](https://github.com/paperclipai/paperclip) (2 days ago) • Open-source orchestration for zero-human companies
- [`rhetro/ordex`](https://github.com/rhetro/ordex) (2 days ago) • A strict, generational arena allocator for Rust
- [`msitarzewski/agency-agents`](https://github.com/msitarzewski/agency-agents) (3 days ago) • A complete AI agency at your fingertips - From frontend wizards to Reddit community ninjas, from whimsy injectors to reality checkers. Each agent is a specialized expert with personality, processes, and proven deliverables.
- [`xu-cheng/latex-action`](https://github.com/xu-cheng/latex-action) (4 days ago) • :octocat: GitHub Action to compile LaTeX documents
- [`andrewyng/context-hub`](https://github.com/andrewyng/context-hub) (4 days ago)
- [`vic/fx-rs`](https://github.com/vic/fx-rs) (4 days ago) • Rust Algebraic Effects System - modeled after https://github.com/vic/fx.go

## My recent Followers

- [`@rhetro`](https://github.com/rhetro)
- [`@Osamagamall`](https://github.com/Osamagamall)
- [`@carlosdonegomez101-cell`](https://github.com/carlosdonegomez101-cell)
- [`@Buidlender`](https://github.com/Buidlender)
- [`@engrshuvodas`](https://github.com/engrshuvodas)
- [`@np868282-cyber`](https://github.com/np868282-cyber)
- [`@BhuvanAde`](https://github.com/BhuvanAde)
- [`@joaocarpim`](https://github.com/joaocarpim)
- [`@lolwilliams`](https://github.com/lolwilliams)
