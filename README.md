...
- [`infiniflow/ragflow`](https://github.com/infiniflow/ragflow) (3 days ago) • RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding.
- [`coderabbitai/awesome-coderabbit`](https://github.com/coderabbitai/awesome-coderabbit) (4 days ago) • Official awesome-list of CodeRabbit Starters &amp; Resources ⚡️
- [`mikeleppane/visualvault`](https://github.com/mikeleppane/visualvault) (4 days ago) • Terminal-based media file organizer with smart date-based organization, duplicate detection, and a beautiful TUI. Organize your photo/video collection efficiently from the command line. Written in Rust using Ratatui
- [`superagent-ai/grok-cli`](https://github.com/superagent-ai/grok-cli) (4 days ago) • An open-source AI agent that brings the power of Grok directly into your terminal.
- [`mina-deploy/mina`](https://github.com/mina-deploy/mina) (4 days ago) • Blazing fast deployer and server automation tool
- [`ignite/apps`](https://github.com/ignite/apps) (5 days ago) • Ignite Apps
- [`toschdev/blockie`](https://github.com/toschdev/blockie) (5 days ago) • Ignite App - Analyses your blocks for you
- [`starship/starship`](https://github.com/starship/starship) (5 days ago) • ☄🌌️ The minimal, blazing-fast, and infinitely customizable prompt for any shell!
- [`Cumulo-pro/Axone`](https://github.com/Cumulo-pro/Axone) (6 days ago)
- [`eco-stake/restake-ui`](https://github.com/eco-stake/restake-ui) (1 week ago) • Auto-compounder app for Cosmos blockchains using Authz

## 👯 My recent Followers

- [`@thornebaker`](https://github.com/thornebaker)
- [`@Hackinet`](https://github.com/Hackinet)
- [`@devddine`](https://github.com/devddine)
- [`@buraxta`](https://github.com/buraxta)
- [`@Khababakhtar20`](https://github.com/Khababakhtar20)
- [`@ArturPanosyan`](https://github.com/ArturPanosyan)
- [`@wilfrid51`](https://github.com/wilfrid51)
- [`@Kintomon`](https://github.com/Kintomon)
- [`@rosedev318`](https://github.com/rosedev318)
...
- [One-liner to conjure all Axone airdrop giga-chads — proof of participation on-chain (https://airdrop.axone.xyz)](https://gist.github.com/25a453db78023df8c8cd7bf9c20be800) (5 months ago)
...
- [A collection of handy one-liners leveraging the Axoned CLI for interacting with the Axone blockchain](https://gist.github.com/44cbc7d8e42f183dcbc78c85ebf404d0) (6 months ago)
