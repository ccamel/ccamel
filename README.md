...
- [`mars-protocol/cw-asset`](https://github.com/mars-protocol/cw-asset) (1 day ago) • A unified representation of various types of Cosmos fungible assets, and helper functions for interacting with them
- [`Fairblock/fairyring`](https://github.com/Fairblock/fairyring) (1 day ago)
- [`block/goose`](https://github.com/block/goose) (3 days ago) • an open-source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM
- [`vhanla/deepseek-r1-unthink`](https://github.com/vhanla/deepseek-r1-unthink) (3 days ago) • Ollama&#39;s API proxy server that captures /api/chat responses and removes &lt;think&gt;&lt;/think&gt; streamed content
- [`luooooob/create-my-awesome`](https://github.com/luooooob/create-my-awesome) (4 days ago) • Github Actions for automatically generating the personal awesome list from all of the repositories you starred.
- [`EspressoSystems/hyperplonk`](https://github.com/EspressoSystems/hyperplonk) (4 days ago)
- [`albttx/horcrux-mnemonic`](https://github.com/albttx/horcrux-mnemonic) (4 days ago) • Split your mnemonic in multiple shares like an Hocrux
- [`deepseek-ai/DeepSeek-V3`](https://github.com/deepseek-ai/DeepSeek-V3) (5 days ago)
- [`piprate/json-gold`](https://github.com/piprate/json-gold) (5 days ago) • A JSON-LD processor for Go
- [`deiu/rdf2go`](https://github.com/deiu/rdf2go) (5 days ago) • Native golang library for RDF (includes parser/serializer for Turtle and JSON-LD)
...
- [`@BigPrinxx`](https://github.com/BigPrinxx)
- [`@reid-harrisson`](https://github.com/reid-harrisson)

## 📕 My Latest Gists

- [Bash sorcery to summon all WASM contracts from the Axone chain and unveil their real nature](https://gist.github.com/f8aea954bc73d5cad3f33812085b3b88) (2 days ago)
- [A collection of handy one-liners leveraging the Axoned CLI for interacting with the Axone blockchain](https://gist.github.com/44cbc7d8e42f183dcbc78c85ebf404d0) (2 weeks ago)
