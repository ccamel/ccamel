...
<ul>
  ...
  <li><code><a href="https://github.com/brumeproject/wallet2">brumeproject/wallet2</a></code>&nbsp;<a href="https://github.com/brumeproject/wallet2/releases/tag/v0.3.0"><img align="center" alt="v0.3.0" src="https://img.shields.io/static/v1?label=&message=v0.3.0&color=gray&style=flat-square" /></a>&nbsp;•&nbsp;The wallet with maximum security and privacy</li>
  ...
  <li><code><a href="https://github.com/axone-protocol/prolog">axone-protocol/prolog</a></code>&nbsp;<a href="https://github.com/axone-protocol/prolog/releases/tag/v3.2.0"><img align="center" alt="v3.2.0" src="https://img.shields.io/static/v1?label=&message=v3.2.0&color=gray&style=flat-square" /></a>&nbsp;•&nbsp;🧠 The Axone Prolog VM</li>
  <li><code><a href="https://github.com/realopslabs/kubeledger">realopslabs/kubeledger</a></code>&nbsp;<a href="https://github.com/realopslabs/kubeledger/releases/tag/v26.01.1"><img align="center" alt="v26.01.1" src="https://img.shields.io/static/v1?label=&message=v26.01.1&color=gray&style=flat-square" /></a>&nbsp;•&nbsp;The System of Record for Kubernetes Accounting. Tracks CPU/RAM/GPU usage per namespace. Reveals hidden overhead. Get Insights for cost optimization. (Formerly Kube-Opex-Analytics).</li>
  <li><code><a href="https://github.com/axone-protocol/axoned">axone-protocol/axoned</a></code>&nbsp;<a href="https://github.com/axone-protocol/axoned/releases/tag/v14.0.0"><img align="center" alt="v14.0.0" src="https://img.shields.io/static/v1?label=&message=v14.0.0&color=gray&style=flat-square" /></a>&nbsp;•&nbsp;⛓️ Axone blockchain 💫</li>
  <li><code><a href="https://github.com/hazae41/bobine">hazae41/bobine</a></code>&nbsp;<a href="https://github.com/hazae41/bobine/releases/tag/v0.0.22"><img align="center" alt="v0.0.22" src="https://img.shields.io/static/v1?label=&message=v0.0.22&color=gray&style=flat-square" /></a>&nbsp;•&nbsp;A blockchain in your garage</li>
  <li><code><a href="https://github.com/ccamel/playground-elm">ccamel/playground-elm</a></code>&nbsp;<a href="https://github.com/ccamel/playground-elm/releases/tag/v3.10.1"><img align="center" alt="v3.10.1" src="https://img.shields.io/static/v1?label=&message=v3.10.1&color=gray&style=flat-square" /></a>&nbsp;•&nbsp; :balloon: My playground for playing with elm-lang</li>
  <li><code><a href="https://github.com/ccamel/erlang-event-sourcing-xp">ccamel/erlang-event-sourcing-xp</a></code>&nbsp;<a href="https://github.com/ccamel/erlang-event-sourcing-xp/releases/tag/v1.1.0"><img align="center" alt="v1.1.0" src="https://img.shields.io/static/v1?label=&message=v1.1.0&color=gray&style=flat-square" /></a>&nbsp;•&nbsp;🧪 Experimenting with Event Sourcing in Erlang</li>
  <li><code><a href="https://github.com/mikeleppane/visualvault">mikeleppane/visualvault</a></code>&nbsp;<a href="https://github.com/mikeleppane/visualvault/releases/tag/v0.8.0"><img align="center" alt="v0.8.0" src="https://img.shields.io/static/v1?label=&message=v0.8.0&color=gray&style=flat-square" /></a>&nbsp;•&nbsp;Terminal-based media file organizer with smart date-based organization, duplicate detection, and a beautiful TUI. Organize your photo/video collection efficiently from the command line. Written in Rust using Ratatui </li>
</ul>
...
- [My personal archive of surrealist prompts](https://gist.github.com/4bed0857811867dcdb5491bfdc975578) (4 months ago)
- [my own collection of absurd and self-referential paradoxes from within the machine](https://gist.github.com/d4c7a7cd812906dfebc61a027805029d) (4 months ago)
- [One-liner sorcery to rip stats from the Axone Cognitarium smart contract (🔗 https://axone.xyz)](https://gist.github.com/75628fd9b042f30cfaaf2507338f9b50) (1 year ago)
- [One-liner to conjure all Axone airdrop giga-chads — proof of participation on-chain (https://airdrop.axone.xyz)](https://gist.github.com/25a453db78023df8c8cd7bf9c20be800) (1 year ago)
- [Bash sorcery to summon all WASM contracts from the Axone chain and unveil their real nature](https://gist.github.com/f8aea954bc73d5cad3f33812085b3b88) (1 year ago)
...
- [Simple magical one-line bash command to graph KatAI contributions over time (https://katai.xyz)](https://gist.github.com/f27603e36d7b4e6f2bfc5c5454f71cdd) (2 years ago)

## Recent Stars

- [`kunwl123456/zeroclaw-skills-collection`](https://github.com/kunwl123456/zeroclaw-skills-collection) (1 day ago) • Recommended skills for ZeroClaw
- [`mergisi/awesome-openclaw-agents`](https://github.com/mergisi/awesome-openclaw-agents) (1 day ago) • 162 production-ready AI agent templates for OpenClaw. SOUL.md configs across 19 categories. Submit yours!
- [`moltis-org/moltis`](https://github.com/moltis-org/moltis) (1 day ago) • A Rust-native claw you can trust. One binary — sandboxed, secure, auditable. Voice, memory, MCP tools, and multi-channel access built-in.
- [`sipeed/picoclaw`](https://github.com/sipeed/picoclaw) (2 days ago) • Tiny, Fast, and Deployable anywhere — automate the mundane, unleash your creativity
- [`kungfusheep/glyph`](https://github.com/kungfusheep/glyph) (2 days ago) • declarative TUI library for Go
- [`anthropics/claude-code`](https://github.com/anthropics/claude-code) (3 days ago) • Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
- [`openai/codex-plugin-cc`](https://github.com/openai/codex-plugin-cc) (3 days ago) • Use Codex from Claude Code to review code or delegate tasks.
- [`atuinsh/eye-declare`](https://github.com/atuinsh/eye-declare) (3 days ago) • A declarative inline TUI rendering library for Rust, built on Ratatui
- [`lantr-io/rustus`](https://github.com/lantr-io/rustus) (3 days ago) • Rustus - yet another smart contract programming language for Cardano
- [`vercel-labs/json-render`](https://github.com/vercel-labs/json-render) (3 days ago) • The Generative UI framework
