...
- [My personal archive of surrealist prompts](https://gist.github.com/4bed0857811867dcdb5491bfdc975578) (7 months ago)
...
- [`copper-engine/copper-engine`](https://github.com/copper-engine/copper-engine) (2 days ago) • COPPER - a high performance Java workflow engine
- [`societe-generale/arch-unit-maven-plugin`](https://github.com/societe-generale/arch-unit-maven-plugin) (3 days ago) • A maven wrapper around ArchUnit, to easily share and enforce architecture rules across projects
- [`ai-boost/awesome-harness-engineering`](https://github.com/ai-boost/awesome-harness-engineering) (4 days ago) • Awesome list for AI agent harness engineering: tools, patterns, evals, memory, MCP, permissions, observability, and orchestration.
- [`crynta/terax-ai`](https://github.com/crynta/terax-ai) (4 days ago) • Lightweight (7MB) Terminal-first AI-native dev workspace
- [`SonarSource/sonarqube-cli`](https://github.com/SonarSource/sonarqube-cli) (4 days ago) • Command-line interface for SonarQube with AI agent integration. Scan for secrets and get fast feedback on code quality and security from your terminal.
- [`MiniMax-AI/MiniMax-M3`](https://github.com/MiniMax-AI/MiniMax-M3) (5 days ago)
- [`nuxt/ui`](https://github.com/nuxt/ui) (1 week ago) • The Intuitive Vue UI Library powered by Reka UI &amp; Tailwind CSS.
- [`yannbolliger/notion-exporter`](https://github.com/yannbolliger/notion-exporter) (1 week ago) • CLI and library for exporting .md and .csv files from any Notion page.
- [`serenakeyitan/tdoc`](https://github.com/serenakeyitan/tdoc) (1 week ago) • Prompt-native interactive HTML docs — bdocs. Generate, comment on, and publish docs from inside codex &amp;Claude Code.
- [`devxplay/herdr.nvim`](https://github.com/devxplay/herdr.nvim) (1 week ago) • Neovim integration for Herdr pane navigation

## My recent Followers

- [`@faizankhan1428`](https://github.com/faizankhan1428)
- [`@kasumiki`](https://github.com/kasumiki)
- [`@super-phantom91`](https://github.com/super-phantom91)
- [`@mrhx01`](https://github.com/mrhx01)
