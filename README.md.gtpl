...
{{range recentReleases 10}}
  <li><code><a href="{{.URL}}">{{.Name}}</a></code>&nbsp;<a href="{{.LastRelease.URL}}"><img align="center" alt="{{.LastRelease.TagName}}" src="https://img.shields.io/static/v1?label=&message={{.LastRelease.TagName | urlquery}}&color=gray&style=flat-square" /></a>&nbsp;•&nbsp;{{.Description}}</li>
{{- end}}
</ul>
